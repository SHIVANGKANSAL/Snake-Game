...
window.onload = () => {
    ...
    // On Click : restart the game action
...
function update() {
    ...
    // Create first food
    createRect(foodX, foodY, blockSize, blockSize, "#295cd6");
    ...
    createRect(snakeX, snakeY, blockSize, blockSize, '#0ad6f5');

    for (let i = 0; i < tail.length; i++) { 
        createRect(tail[i][0], tail[i][1], blockSize, blockSize, '#295cd6');
    }
...
function createRect(x, y, width, height, color = "#ccd9ff" ) {
